...
/**
 * Base class for all Mikey extension errors
 */
export abstract class MikeyError extends Error {
 ...
 */
export class PrdFileError extends MikeyError {
  constructor(
    message: string,
    code: string,
    suggestion: string,
 ...
 */
export class GitOperationError extends MikeyError {
  constructor(
    message: string,
    code: string,
    suggestion: string,
 ...
 */
export class UserInputError extends MikeyError {
 ...
 */
export class EnvironmentError extends MikeyError {
  constructor(
    message: string,
    code: string,
    suggestion: string,
  ...
  static noWorkspace(): EnvironmentError {
    return new EnvironmentError(
      ...
      "NO_WORKSPACE",
      "Open a workspace folder to use Mikey extension.",
    );
  }
...
/**
 * Type guard to check if an error is a MikeyError
 */
export function isMikeyError(error: unknown): error is MikeyError {
  return error instanceof MikeyError;
}
